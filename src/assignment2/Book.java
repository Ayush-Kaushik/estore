...
public class Book extends Product {
     ...
     * @param author - receives a variable (String author) from add method which is used to create member of instance object of book class
     * @param publisher - this receives a variable (String publisher) from add method which is used to create member of instance object of book class
     */
    ...
    /**
     * @return publisher - If user input is valid, it returns user input - publisher name
     * This method uses try and catch blocks to error check.
     */
    ...
    //------------------- SET AND GET AUTHOR ---------------//
    /**
     * @param author_ - this receives a variable from add method which is used to create member of instance object of book class
     */
    ...
    /**
     * @return this.author - this returns the member of instance object of type Book created
     */
...
//----------------- SET AND GET PUBLISHER -------------//
    ...
    /**
     * @param publisher_ - this receives a variable from add method which is used to create member of instance object of book class
     */
    ...
    /**
     * @return this.publisher - this returns the member of instance object of type Book created
     */
    ...
    {
        return "item ID: " + getID() + ", "+ "Name of item:" + ", " + getName() + ", " + "Year: " + getYear() + ", "+ "Price: " + getPrice() + ", "+ "Author: " + getAuthor() + ", "+ "Publisher: " + getPublisher();
    }
